                ...
                <div class="col-lg-7">
                    <div class="row">
                        <div class="col-lg-12 rarities">
                            <img width='30'  :src="require(`../assets/nav-icons/${(item.weaponElement).toLowerCase()}.png`)" alt="">
                            <span :style="setRarityColor(item.weaponStars)">{{setRarityName(item.weaponStars)}}</span>
                        </div>
                        <div class="col-lg-12 titles">
                            <h4>{{(getWeaponNameFromSeed(item.weaponId,item.weaponStars)).toUpperCase()}}</h4>
                            <div class="d-flex">
