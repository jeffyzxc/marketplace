...
export interface Characters {
  ...
  getPVEStats(id: string | number): Web3JsAbiCall<[string, string]>;
  incrementPVEWins(id: string | number): Web3JsAbiCall<void>;
  incrementPVELosses(id: string | number): Web3JsAbiCall<void>;
...
export interface CryptoBlades {
  DEFAULT_ADMIN_ROLE(): Web3JsAbiCall<string>;
  GAME_ADMIN(): Web3JsAbiCall<string>;
  MINT_PAYMENT_RECLAIM_MINIMUM_WAIT_TIME(): Web3JsAbiCall<string>;
  MINT_PAYMENT_TIMEOUT(): Web3JsAbiCall<string>;
  ...
  setCharacterLimit(max: string | number): Web3JsAbiCall<void>;
  setRewardsClaimTaxMax(_rewardsClaimTaxMax: string | number): Web3JsAbiCall<void>;
  setRewardsClaimTaxMaxAsRational(_numerator: string | number, _denominator: string | number): Web3JsAbiCall<void>;
